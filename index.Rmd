...
Why doesn't `docs/` get all the files from `/`? Currently I only see `style.css` and `email_submit.html`. That's odd, and stops the custom blocks from looking as they should. 
