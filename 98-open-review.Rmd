...
Yes, all the annotations are public. You can see them on right hand side of the each page or you can read them in [stream form](https://hypothes.is/stream?q=https://hypothes.is/stream?q=benmarwick-bookdown-ort).
